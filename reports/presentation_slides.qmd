...
[![](git-workflow-image-1.png)](https://newsletter.techworld-with-milan.com/p/how-to-learn-git){fig-align="center"}
...
You can perform many actions in GitHub via the browser, but most people work on their own machine and then continually sync local changes to the central repository on GitHub
...
Virtual tour of DASP-OPDR's GitHub page.
