...
![](git-logo.png){fig-align="center"}

Git is a [**distributed version control system**]{.ul} that tracks versions of files. It is often used to control source code by programmers who are developing software collaboratively.

## Distributed version control

![](distributed-version-control-diagram.png)
